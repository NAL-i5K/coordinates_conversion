...
class BedUpdater(object):

    def __init__(self, alignment_list_tsv_file, updated_postfix, removed_postfix):
        self.alignment_list = BedUpdater.read_alignment_list_tsv(alignment_list_tsv_file)
    ...
    def update(self, Bed_file):
        """
        Updates the Bed_file using the alignment_list_tsv_file
        :param str Bed_file: The Bed file to be updated
        """
    ...
    def _update_features(self):
        """
        Goes through the Bed file, updating the ids and coordinates of each line and
        checks for removed ids and coordinates.
        """
        from os.path import splitext
        Bed_root, Bed_ext = splitext(self.Bed_file)
        updated_file = Bed_root + self.updated_postfix + Bed_ext
...
if __name__ == '__main__':
    ...
    Update the sequence id and coordinates of a Bed file using an alignment file generated by the fasta_diff.py program.
    ...
    Example:
        fasta_diff.py old.fa new.fa | %(prog)s a.Bed b.Bed c.Bed
    """))
    parser.add_argument('Bed_files', metavar='Bed_FILE', nargs='+', type=str,
    help='List one or more Bed files to be updated')
    ...
    bed_updater = BedUpdater(args.alignment_file, args.updated_postfix, args.removed_postfix)
    for bed_file in args.Bed_files:
        bed_updater.update(bed_file)
